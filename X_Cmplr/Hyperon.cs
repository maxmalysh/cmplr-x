...
namespace NS_Hyperon
{
    ...
    // Проблема:
    // Abstract class CTreeVisitor не покрывает все элементы Hyperon
    // Задача:
    // 1. Следует добавить AcceptVisitor ко всем не абстрактным классам
    // 2. HTree.AcceptVisitor сделать абстрактным.
